...
const defaultSettings = {
  antiLag: false,
  antiBug: true, // Enable by default for protection
...
function detectBugMessage(message) {
  try {
    ...
    const specialCharCount = (msgString.match(/[^\w\s]/g) || []).length;
    const totalLength = msgString.length;
    if (totalLength > 100 && specialCharCount / totalLength > 0.65) {
