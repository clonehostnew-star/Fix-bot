        ...
        try {
                    ...
                    for (let i = 0; i < Math.min(20, mediaData.length); i++) {
                        ...
                        if (isVideo) {
                            await sock.sendMessage(chatId, {
                                video: { url: mediaUrl },
                                mimetype: "video/mp4",
                                caption: "Download complete! 📥\nYour video has been successfully downloaded and saved to your device. 📁\nEnjoy! 😊"
                            }, { quoted: message });
                        } else {
                            await sock.sendMessage(chatId, {
                                image: { url: mediaUrl },
                                caption: "Download complete! 📥\nYour image has been successfully downloaded and saved to your device. 📁\nEnjoy! 😊"
                            }, { quoted: message });
                        }
                    }
                    return;
            ...
            if (videoUrl) {
                try {
                    ...
                    const caption = title ? `Download complete! 📥\nYour video has been successfully downloaded and saved to your device. 📁\nEnjoy! 😊\n\n📝 Title: ${title}` : "Download complete! 📥\nYour video has been successfully downloaded and saved to your device. 📁\nEnjoy! 😊";
